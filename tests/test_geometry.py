...
def test_warp_perspective_identity_matches_input():
    ...
    # Optimized implementation uses float32 instead of float64, naturally introducing
    # minor precision variations. Update allclose tolerance from default to
    # atol=1e-3.
    assert torch.allclose(out, src, atol=1e-3)
