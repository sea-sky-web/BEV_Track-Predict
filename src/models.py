...
class MVDetLikeNet(nn.Module):
    ...
    def forward(
        ...
        # Performance optimization: Vectorize view dimension processing
        # Flatten batch and view dimensions for synchronous batched operations
        x_flat = x_views.reshape(B * V, C, H, W)
